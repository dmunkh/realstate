...
export default function AboutPage() {
  const items = [
    ...
    },
    {
      ...
      title: "Item Eight",
      price: "$800",
      description: "This is a description of item eightThis is a description of item eightThis is a description of item eightThis is a description of item eight.",
    },
  ];
